...
if csv_files:
    ...
    statement = f"select distinct file_name from " \
                f"datamart_project.product_staging_table " \
...
# ['s3://etl-datamart-project/sales_data/extra_column_data.csv', 's3://etl-datamart-project/sales_data/file5.json', 's3://etl-datamart-project/sales_data/less_column_data.csv', 's3://etl-datamart-project/sales_data/my_data.csv']
...
# Additinal columns need to be taken care of
...
# Read the data from parquet and generates a csv file
...
logger.info("*************** Deleting sales_team data from local ****************")
delete_local_file(config.sales_team_data_mart_local_file)
logger.info("*************** Deleted sales_team data from local *****************")


logger.info("*************** Deleting sales_team_partitioned data from local ****************")
delete_local_file(config.sales_team_data_mart_partitioned_local_file)
logger.info("*************** Deleted sales_team_partitioned data from local *****************")
